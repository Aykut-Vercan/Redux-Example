  ...
  switch (action.type) {
    case "ADD_COMMENT":
      return _objectSpread(_objectSpread({}, state), {}, {
        comments: [action.payload].concat(_toConsumableArray(state.comments))
      });
    default:
      return state;
  }
};
var _default = (0, _redux.createStore)(commentReducer);
exports.default = _default;
...
var renderComments = function renderComments() {
  var _store$getState = _store.default.getState(),
    comments = _store$getState.comments;
  var commentList = comments.map(function (_ref) {
    var body = _ref.body,
      id = _ref.id;
    return "<div>\n                    <img src=\"https://randomuser.me/api/portraits/women/".concat(id, ".jpg\" />\n                     <span>").concat(body, "</span>\n                </div>");
  }).join("");
...
var renderCommentCount = function renderCommentCount() {
  var _store$getState2 = _store.default.getState(),
    comments = _store$getState2.comments;
...
},{"./style.css":"src/style.css","./store":"src/store.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
